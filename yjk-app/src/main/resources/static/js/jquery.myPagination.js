	...
	function init(param, obj) {
		if (param && param instanceof Object) {
			...
			var defaults = new Object({currPage:1, pageCount:10, pageSize:5, cssStyle:"badoo", ajax:{on:false, pageCountId:"pageCount", param:{on:false, page:1}, ajaxStart:function () {
				return false;
			}}, info:{first:"\u9996\u9875", last:"\u5c3e\u9875", next:"\u4e0b\u4e00\u9875", prev:"\u4e0a\u4e00\u9875", first_on:true, last_on:true, next_on:true, prev_on:true, msg_on:true, link:"#", msg:"<span>&nbsp;&nbsp;\u8df3{currText}/{sumPage}\u9875</span>", text:{width:"22px"}}});
