...
@Service
public class TwoStagemodelService {
	...
	public String list(String page,String keyword,Long pid) {
		...
		if(pid != null) {
			createCriteria.andEqualTo("modelId",pid);
		}
		List<TwoStagemodelDO> modelList = twoStagemodelMapper.selectByExample(example);
		PageInfo<TwoStagemodelDO> pageInfo=new PageInfo<>(modelList);
